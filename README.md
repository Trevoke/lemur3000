...
lemur3000 is a chat bot built on the [Hubot][hubot] framework. It was initially generated by [generator-hubot][generator-hubot], and configured to be deployed on [Heroku][heroku] to get you up and running as quick as possible.
...
### Running lemur3000 Locally

You can test your hubot by running the following.

You can start lemur3000 locally by running:
...
Then you can interact with lemur3000 by typing `lemur3000 help`.

    lemur3000> lemur3000 help

    lemur3000> animate me <query> - The same thing as `image me`, except adds a few
